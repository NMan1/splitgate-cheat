...
class UAlertButton_C : public UPortalWarsButtonWidget
{
public:
	...
	unsigned char                                      UnknownData_UU5R[0x7];                                     // 0x03E1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass AlertButton.AlertButton_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AlertButton(int EntryPoint);
};
