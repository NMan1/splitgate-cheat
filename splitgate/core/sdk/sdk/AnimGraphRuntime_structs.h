...
struct FAnimNode_SkeletalControlBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_MAJ9[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZDBI[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendSpacePlayer : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_BK3L[0x2];                                     // 0x004A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y1GP[0x88];                                    // 0x0058(0x0088) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_YOHS[0x68];                                    // 0x00E8(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_72JF[0x30];                                    // 0x0190(0x0030) MISSED OFFSET (PADDING)
...
struct FRotationRetargetingInfo
{
	...
	unsigned char                                      UnknownData_Q898[0xF];                                     // 0x0001(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q8Z4[0x3];                                     // 0x0071(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HG2H[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_07WF[0x3];                                     // 0x0095(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_93VG[0x3];                                     // 0x0121(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U96I[0x7];                                     // 0x0129(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimPhysConstraintSetup
{
	...
	unsigned char                                      UnknownData_TKAH[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PPOT[0x1];                                     // 0x001F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimPhysSphericalLimit
{
	...
	unsigned char                                      UnknownData_1JKH[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimNode_AnimDynamics : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_FU7L[0x60];                                    // 0x00D0(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FGL1[0x4];                                     // 0x020C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T5PJ[0x2];                                     // 0x0242(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7ZUD : 1;                                      // 0x0245(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_R65U[0xA];                                     // 0x0246(0x000A) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FRotationRetargetingInfo                    RetargetingSettings;                                       // 0x0250(0x0130) (Edit, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_F9FJ[0xC0];                                    // 0x0380(0x00C0) MISSED OFFSET (PADDING)
...
struct FAnimNode_ApplyAdditive : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_LJCX[0x4];                                     // 0x00C0(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V6FO[0x2];                                     // 0x00C6(0x0002) MISSED OFFSET (PADDING)
...
struct FBlendBoneByChannelEntry
{
	...
	unsigned char                                      UnknownData_70JU[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendBoneByChannel : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_OFZH[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F1OW[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7AS2[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_58IS[0x5];                                     // 0x0033(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DHQR[0x50];                                    // 0x0048(0x0050) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListByBool : public FAnimNode_BlendListBase
{
	...
	unsigned char                                      UnknownData_XU44[0x7];                                     // 0x0099(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListByEnum : public FAnimNode_BlendListBase
{
	...
	unsigned char                                      UnknownData_TLBP[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListByInt : public FAnimNode_BlendListBase
{
	...
	unsigned char                                      UnknownData_JVP1[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendSpaceEvaluator : public FAnimNode_BlendSpacePlayer
{
	...
	unsigned char                                      UnknownData_80EJ[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_BoneDrivenController : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_078V[0x7];                                     // 0x0111(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NBN8[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TFQ1[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
struct FBoneSocketTarget
{
	...
	unsigned char                                      UnknownData_AVYT[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FBoneReference                              BoneReference;                                             // 0x0004(0x0010) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_30EJ[0xC];                                     // 0x0014(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_CCDIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_O038[0xB];                                     // 0x00D5(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DH0G[0x6];                                     // 0x016A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FConstraint
{
	...
	unsigned char                                      UnknownData_VP5R[0x7];                                     // 0x0015(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_Constraint : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_DEM5[0x10];                                    // 0x00F8(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimNode_CopyBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_YELI[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_CopyPoseFromMesh : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_Q4G6[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XNCA[0x1B4];                                   // 0x0024(0x01B4) MISSED OFFSET (PADDING)
...
struct FAnimNode_CurveSource : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_4GIC[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_U0K5[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8P6E[0x6];                                     // 0x018A(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_HandIKRetargeting : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_WCFE[0x4];                                     // 0x011C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_LayeredBoneBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_YG5P[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XW9C[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0C61[0x30];                                    // 0x0090(0x0030) MISSED OFFSET (PADDING)
...
struct FAnimNode_LegIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_623C[0x18];                                    // 0x00E0(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_N5XR[0xA0];                                    // 0x0000(0x00A0) MISSED OFFSET (PADDING)
...
struct FIKChain
{
	unsigned char                                      UnknownData_HPN4[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FIKChainLink
{
	unsigned char                                      UnknownData_WO9C[0x3C];                                    // 0x0000(0x003C) MISSED OFFSET (PADDING)
...
{
	struct FBoneReference                              BoneToModify;                                              // 0x00C8(0x0010) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_NJ6R[0x8];                                     // 0x00D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XUNT[0x2];                                     // 0x015E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9Z9Q[0x34];                                    // 0x017C(0x0034) MISSED OFFSET (PADDING)
...
struct FAnimNode_MakeDynamicAdditive : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_X4WN[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_ModifyBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_YLL3[0x6];                                     // 0x0102(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_ModifyCurve : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_62F8[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Alpha;                                                     // 0x0050(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_JCXG[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimNode_MultiWayBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_YXDP[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DB5D[0x6];                                     // 0x004A(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_ObserveBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_42ZC[0x2];                                     // 0x00DA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_PoseHandler : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_FNBW[0x40];                                    // 0x0040(0x0040) MISSED OFFSET (PADDING)
...
struct FAnimNode_PoseBlendNode : public FAnimNode_PoseHandler
{
	...
	unsigned char                                      UnknownData_7MZ2[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_PoseByName : public FAnimNode_PoseHandler
{
	...
	unsigned char                                      UnknownData_Z8QP[0xC];                                     // 0x008C(0x000C) MISSED OFFSET (PADDING)
...
struct FRBFParams
{
	...
	unsigned char                                      UnknownData_UEEN[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DHR0[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPoseDriverTarget
{
	...
	unsigned char                                      UnknownData_FXDZ[0x5];                                     // 0x0023(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HK2M[0x8];                                     // 0x00B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X03H[0x7];                                     // 0x00B9(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_PoseDriver : public FAnimNode_PoseHandler
{
	...
	unsigned char                                      UnknownData_YAQF[0x30];                                    // 0x00C0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZF28[0x1];                                     // 0x012F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3IT9[0x34];                                    // 0x0134(0x0034) MISSED OFFSET (PADDING)
...
struct FAnimNode_PoseSnapshot : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_XMZ1[0x3F];                                    // 0x0051(0x003F) MISSED OFFSET (PADDING)
...
struct FRandomPlayerSequenceEntry
{
	...
	unsigned char                                      UnknownData_EU3V[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_RandomPlayer : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_7PVX[0x50];                                    // 0x0020(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FWU8[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_RefPose : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_UVAV[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_X4ME[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimNode_RigidBody : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_IMOD[0x98];                                    // 0x00D0(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5Z8V[0x1];                                     // 0x01FB(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BNSC[0x3];                                     // 0x01FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VLQP[0x628];                                   // 0x0208(0x0628) MISSED OFFSET (PADDING)
...
struct FAnimNode_RotateRootBone : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_14WD[0xC];                                     // 0x0094(0x000C) MISSED OFFSET (PADDING)
...
struct FAnimNode_RotationMultiplier : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_VNW2[0x2];                                     // 0x00EE(0x0002) MISSED OFFSET (PADDING)
...
struct FAnimNode_RotationOffsetBlendSpace : public FAnimNode_BlendSpacePlayer
{
	...
	unsigned char                                      UnknownData_FOVN[0x4];                                     // 0x0188(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0K1A[0x2];                                     // 0x018E(0x0002) MISSED OFFSET (PADDING)
...
struct FAnimNode_ScaleChainLength : public FAnimNode_Base
{
	...
	float                                              Alpha;                                                     // 0x0050(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_HM5A[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5ALQ[0x17];                                    // 0x0061(0x0017) MISSED OFFSET (PADDING)
...
struct FAnimNode_SequenceEvaluator : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_NKEL[0x1];                                     // 0x0047(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VVCV[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_Slot : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_L8TK[0x1F];                                    // 0x0029(0x001F) MISSED OFFSET (PADDING)
...
struct FAnimNode_SplineIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_X741[0x2];                                     // 0x00EA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_01KN[0x4];                                     // 0x010C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SSGA[0x128];                                   // 0x0148(0x0128) MISSED OFFSET (PADDING)
...
struct FAnimNode_SpringBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_67XA[0x3C];                                    // 0x00E8(0x003C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZFHF[0x3];                                     // 0x0125(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0JFQ[0x38];                                    // 0x00C8(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9JDH[0x2];                                     // 0x0116(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_14BE[0x34];                                    // 0x022C(0x0034) MISSED OFFSET (PADDING)
...
struct FAnimNode_TwistCorrectiveNode : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_71PL[0x8];                                     // 0x0130(0x0008) MISSED OFFSET (PADDING)
...
struct FAnimNode_TwoBoneIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_HH0D[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P84E[0x4];                                     // 0x015C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DP6T[0xD];                                     // 0x01D3(0x000D) MISSED OFFSET (PADDING)
...
struct FAnimNode_TwoWayBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_I884 : 2;                                      // 0x0031(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_V6L4[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FName                                       AlphaCurveName;                                            // 0x0088(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FInputScaleBiasClamp                        AlphaScaleBiasClamp;                                       // 0x0090(0x0030) (Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_WI2J[0x8];                                     // 0x00C0(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OHG9[0x2A0];                                   // 0x0770(0x02A0) MISSED OFFSET (PADDING)
...
struct FPositionHistory
{
	...
	unsigned char                                      UnknownData_9G6C[0x1C];                                    // 0x0014(0x001C) MISSED OFFSET (PADDING)
...
struct FRBFTarget : public FRBFEntry
{
	...
	unsigned char                                      UnknownData_UXMT[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_31PO[0x6];                                     // 0x009A(0x0006) MISSED OFFSET (PADDING)
