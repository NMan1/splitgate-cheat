...
{
	unsigned char                                      UnknownData_8LOO[0x80];                                    // 0x0000(0x0080) MISSED OFFSET (PADDING)
...
struct FAxis
{
	...
	unsigned char                                      UnknownData_2O9C[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintDescriptor
{
	...
	unsigned char                                      UnknownData_VHXD[0xF];                                     // 0x0001(0x000F) MISSED OFFSET (PADDING)
...
struct FConstraintData
{
	...
	unsigned char                                      UnknownData_OOIQ[0xB];                                     // 0x0015(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_BCTC[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FFilterOptionPerAxis                        AxesFilterOption;                                          // 0x0008(0x0003) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_BONW[0x5];                                     // 0x000B(0x0005) MISSED OFFSET (PADDING)
...
struct FAimConstraintDescription : public FConstraintDescriptionEx
{
	...
	unsigned char                                      UnknownData_40RK[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTransformConstraintDescription : public FConstraintDescriptionEx
{
	...
	unsigned char                                      UnknownData_IR0X[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FTransformConstraint
{
	...
	unsigned char                                      UnknownData_MJBL[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H6JR[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintOffset
{
	...
	unsigned char                                      UnknownData_3WKO[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AJHF[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_N23Q[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZN48[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FVector                                     Location;                                                  // 0x0000(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_8GCL[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
