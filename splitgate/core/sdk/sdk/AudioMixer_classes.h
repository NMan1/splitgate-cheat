...
{
public:
	unsigned char                                      UnknownData_LJAC[0x8];                                     // 0x01F8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_EILH[0x3];                                     // 0x0649(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B8ZB[0x4];                                     // 0x0654(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q333[0x20];                                    // 0x0668(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L3SV[0x28];                                    // 0x0698(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AXJ0[0x80];                                    // 0x0028(0x0080) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AN6F[0x168];                                   // 0x0028(0x0168) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YS2N[0x88];                                    // 0x0068(0x0088) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_139E[0x38];                                    // 0x0068(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_K6Q6[0x68];                                    // 0x0068(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_O482[0x40];                                    // 0x0040(0x0040) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_V4J6[0x18];                                    // 0x03C8(0x0018) MISSED OFFSET (PADDING)
