...
class UBlockedPlayers_WidgetBP_C : public UPortalWarsBlockedPlayersWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BlockedPlayers_WidgetBP.BlockedPlayers_WidgetBP_C");
		return ptr;
	}
