...
// WidgetBlueprintGeneratedClass BlueButtonBase.BlueButtonBase_C
// 0x0030 (FullSize[0x03F0] - InheritedSize[0x03C0])
class UBlueButtonBase_C : public UPortalWarsButtonWidget
{
public:
	...
	unsigned char                                      UnknownData_LXQO[0x7];                                     // 0x03E1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BlueButtonBase.BlueButtonBase_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BlueButtonBase(int EntryPoint);
};
