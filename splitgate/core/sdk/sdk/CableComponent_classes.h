...
{
public:
	unsigned char                                      UnknownData_ZBN1[0x8];                                     // 0x0478(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_9MDJ[0x3];                                     // 0x04D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ETV0[0x1C];                                    // 0x04F4(0x001C) MISSED OFFSET (PADDING)
