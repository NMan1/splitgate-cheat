...
class UChallengeEntryFeaturedLarge_WidgetBP_C : public UPortalWarsChallengeEntryWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass ChallengeEntryFeaturedLarge_WidgetBP.ChallengeEntryFeaturedLarge_WidgetBP_C");
		return ptr;
	}
