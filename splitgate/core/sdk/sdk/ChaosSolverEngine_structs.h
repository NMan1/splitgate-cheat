...
{
	unsigned char                                      UnknownData_S2Q6[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_YSJX[0x40];                                    // 0x0000(0x0040) MISSED OFFSET (PADDING)
...
struct FChaosPhysicsCollisionInfo
{
	...
	unsigned char                                      UnknownData_OBKG[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
