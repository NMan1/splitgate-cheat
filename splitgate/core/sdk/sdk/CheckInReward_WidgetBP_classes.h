...
class UCheckInReward_WidgetBP_C : public UPortalWarsCheckInRewardWidget
{
public:
	...
	class UImage*                                      RewardMissedBG;                                            // 0x07A0(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass CheckInReward_WidgetBP.CheckInReward_WidgetBP_C");
		return ptr;
	}
