...
struct FClothLODDataCommon
{
	...
	unsigned char                                      UnknownData_GX19[0x3];                                     // 0x0139(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9ISE[0x20];                                    // 0x0140(0x0020) MISSED OFFSET (PADDING)
...
struct FClothConfig_Legacy
{
	...
	unsigned char                                      UnknownData_W3PA[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HZUV[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothParameterMask_Legacy
{
	...
	unsigned char                                      UnknownData_7LSU[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VTHC[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LRKQ[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
