...
{
public:
	unsigned char                                      UnknownData_N16U[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class ClothingSystemRuntimeInterface.ClothingInteractor");
		return ptr;
	}
...
{
public:
	TMap<struct FName, class UClothingInteractor*>     ClothingInteractors;                                       // 0x0028(0x0050) (NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_6JRC[0x18];                                    // 0x0078(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_10CV[0x50];                                    // 0x0090(0x0050) MISSED OFFSET (PADDING)
