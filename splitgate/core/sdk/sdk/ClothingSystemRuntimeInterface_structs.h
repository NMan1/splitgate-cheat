...
struct FClothCollisionPrim_Box
{
	...
	unsigned char                                      UnknownData_UBZF[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothCollisionPrim_ConvexFace
{
	...
	TArray<int>                                        Indices;                                                   // 0x0010(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
...
struct FClothCollisionPrim_Convex
{
	...
	unsigned char                                      UnknownData_ASGN[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
