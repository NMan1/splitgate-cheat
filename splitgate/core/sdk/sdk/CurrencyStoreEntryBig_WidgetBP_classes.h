...
// WidgetBlueprintGeneratedClass CurrencyStoreEntryBig_WidgetBP.CurrencyStoreEntryBig_WidgetBP_C
// 0x0020 (FullSize[0x0568] - InheritedSize[0x0548])
class UCurrencyStoreEntryBig_WidgetBP_C : public UPortalWarsCurrencyStoreEntry
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass CurrencyStoreEntryBig_WidgetBP.CurrencyStoreEntryBig_WidgetBP_C");
		return ptr;
	}
