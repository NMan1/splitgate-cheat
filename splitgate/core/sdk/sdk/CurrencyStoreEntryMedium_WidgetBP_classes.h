...
class UCurrencyStoreEntryMedium_WidgetBP_C : public UPortalWarsCurrencyStoreEntry
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass CurrencyStoreEntryMedium_WidgetBP.CurrencyStoreEntryMedium_WidgetBP_C");
		return ptr;
	}
