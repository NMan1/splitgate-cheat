...
struct FAdaptorPolygon2Group
{
	...
	unsigned char                                      UnknownData_M609[0x3C];                                    // 0x000C(0x003C) MISSED OFFSET (PADDING)
...
struct FAdaptorPolygon
{
	...
	unsigned char                                      UnknownData_AC88[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_M8WQ[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FMeshElementAttributeData
{
	...
	unsigned char                                      UnknownData_UA3D[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPolygonGroupToCreate
{
	...
	unsigned char                                      UnknownData_8SXM[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	struct FPolygonID                                  PolygonID;                                                 // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_E4T1[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FPolygonID                                  PolygonID;                                                 // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_66QW[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAttributesForEdge
{
	...
	unsigned char                                      UnknownData_EZPH[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAttributesForVertexInstance
{
	...
	unsigned char                                      UnknownData_F68X[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FVertexID                                   VertexID;                                                  // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_JSOB[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FPolygonID                                  PolygonID;                                                 // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_K1B4[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPolygonToCreate
{
	...
	unsigned char                                      UnknownData_K1SO[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O1UZ[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FEdgeToCreate
{
	...
	unsigned char                                      UnknownData_EGCL[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
{
	struct FVertexID                                   VertexID;                                                  // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_08HM[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMeshElementAttributeList                   VertexInstanceAttributes;                                  // 0x0008(0x0010) (BlueprintVisible, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_XDZ7[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FVertexToCreate
{
	...
	unsigned char                                      UnknownData_ZGTI[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSubdividedWireEdge
{
	...
	unsigned char                                      UnknownData_V0KP[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FRenderingPolygonGroup
{
	...
	int                                                MaterialIndex;                                             // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int                                                MaxTriangles;                                              // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_0WQA[0x3C];                                    // 0x000C(0x003C) MISSED OFFSET (PADDING)
...
{
	struct FPolygonGroupID                             PolygonGroupID;                                            // 0x0000(0x0004) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_QD4J[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
