...
struct FEngineServicePong
{
	...
	unsigned char                                      UnknownData_Y1DR[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NC14[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DHLT[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
