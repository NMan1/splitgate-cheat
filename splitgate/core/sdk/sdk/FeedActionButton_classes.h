...
class UFeedActionButton_C : public UPortalWarsButtonWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass FeedActionButton.FeedActionButton_C");
		return ptr;
	}
