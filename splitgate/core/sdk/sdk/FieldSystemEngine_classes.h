...
{
public:
	unsigned char                                      UnknownData_EYK2[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
// 0x00D0 (FullSize[0x0520] - InheritedSize[0x0450])
...
public:
	...
	unsigned char                                      UnknownData_K4QV[0x6];                                     // 0x045A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      SupportedSolvers[0x10];                                    // 0x045A(0x0010) UNKNOWN PROPERTY: ArrayProperty
	...
	unsigned char                                      UnknownData_SODP[0x50];                                    // 0x04D0(0x0050) MISSED OFFSET (PADDING)
	...
	void AddPersistentField(bool Enabled, TEnumAsByte<Chaos_EFieldPhysicsType> Target, class UFieldSystemMetaData* MetaData, class UFieldNodeBase* Field);
...
public:
	...
	unsigned char                                      UnknownData_5BEW[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JRLC[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	TEnumAsByte<Chaos_EFieldFilterType>                FilterType;                                                // 0x00B0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_9J4E[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class FieldSystemEngine.FieldSystemMetaDataFilter");
		return ptr;
	}



	class UFieldSystemMetaDataFilter* SetMetaDataFilterType(TEnumAsByte<Chaos_EFieldFilterType> FilterType);
};
...
public:
	...
	unsigned char                                      UnknownData_6QCY[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MNJU[0x7];                                     // 0x00C9(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2M7N[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	TEnumAsByte<Chaos_EWaveFunctionType>               Function;                                                  // 0x00C8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TEnumAsByte<Chaos_EFieldFalloffType>               Falloff;                                                   // 0x00C9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_4Y11[0x6];                                     // 0x00CA(0x0006) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class FieldSystemEngine.WaveScalar");
		return ptr;
	}



	class UWaveScalar* SetWaveScalar(float Magnitude, const struct FVector& Position, float Wavelength, float Period, float Time, TEnumAsByte<Chaos_EWaveFunctionType> Function, TEnumAsByte<Chaos_EFieldFalloffType> Falloff);
};
...
public:
	...
	unsigned char                                      UnknownData_MHD2[0x7];                                     // 0x00D1(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Z3KD[0x3];                                     // 0x00DD(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NLNX[0xF];                                     // 0x00F1(0x000F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NGX5[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  Transform;                                                 // 0x00C0(0x0030) (Edit, BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	float                                              Magnitude;                                                 // 0x00B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_SIUT[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)
...
public:
	float                                              Magnitude;                                                 // 0x00B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_2ZBU[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DJZZ[0x7];                                     // 0x00C9(0x0007) MISSED OFFSET (PADDING)
	...
	class UOperatorField* SetOperatorField(float Magnitude, class UFieldNodeBase* LeftField, class UFieldNodeBase* RightField, TEnumAsByte<Chaos_EFieldOperationType> Operation);
};
...
public:
	...
	unsigned char                                      UnknownData_1T1B[0x7];                                     // 0x00C1(0x0007) MISSED OFFSET (PADDING)
