...
struct FImageWriteOptions
{
	...
	unsigned char                                      UnknownData_EC4Y[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_54Q7[0x46];                                    // 0x001A(0x0046) MISSED OFFSET (PADDING)
