...
class UItemShopEntryFeatured_WidgetBP_C : public UPortalWarsItemShopEntry
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass ItemShopEntryFeatured_WidgetBP.ItemShopEntryFeatured_WidgetBP_C");
		return ptr;
	}
