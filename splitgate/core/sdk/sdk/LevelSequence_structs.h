...
{
	unsigned char                                      UnknownData_W8PD[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FLevelSequenceObject
{
	...
	unsigned char                                      UnknownData_FQEM[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSequenceAnimSequenceLinkItem
{
	...
	unsigned char                                      UnknownData_3ZTU[0x5];                                     // 0x002B(0x0005) MISSED OFFSET (PADDING)
...
struct FLevelSequenceSnapshotSettings
{
	...
	unsigned char                                      UnknownData_E7WM[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSequencePlayerSnapshot
{
	...
	unsigned char                                      UnknownData_KSQW[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OQSG[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TPO7[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5MOS[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
