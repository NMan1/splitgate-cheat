...
{
public:
	unsigned char                                      UnknownData_2Y35[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K8NO[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (PADDING)
