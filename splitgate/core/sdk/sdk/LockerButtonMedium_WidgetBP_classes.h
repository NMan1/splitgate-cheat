...
// WidgetBlueprintGeneratedClass LockerButtonMedium_WidgetBP.LockerButtonMedium_WidgetBP_C
// 0x0020 (FullSize[0x0478] - InheritedSize[0x0458])
class ULockerButtonMedium_WidgetBP_C : public UPortalWarsLockerButtonWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass LockerButtonMedium_WidgetBP.LockerButtonMedium_WidgetBP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_LockerButtonMedium_WidgetBP(int EntryPoint);
};
