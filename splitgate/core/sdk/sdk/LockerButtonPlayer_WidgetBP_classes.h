...
// WidgetBlueprintGeneratedClass LockerButtonPlayer_WidgetBP.LockerButtonPlayer_WidgetBP_C
// 0x0020 (FullSize[0x0478] - InheritedSize[0x0458])
class ULockerButtonPlayer_WidgetBP_C : public UPortalWarsLockerButtonWidget
{
public:
	...
	class UPlayerEntry_C*                              PlayerEntry;                                               // 0x0468(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass LockerButtonPlayer_WidgetBP.LockerButtonPlayer_WidgetBP_C");
		return ptr;
	}
