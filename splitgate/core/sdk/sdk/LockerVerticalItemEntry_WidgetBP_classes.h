...
// WidgetBlueprintGeneratedClass LockerVerticalItemEntry_WidgetBP.LockerVerticalItemEntry_WidgetBP_C
// 0x0030 (FullSize[0x04E8] - InheritedSize[0x04B8])
class ULockerVerticalItemEntry_WidgetBP_C : public UPortalWarsLockerEntryWidget
{
public:
	...
	class UImage*                                      NormalButtonBG;                                            // 0x04D8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UImage*                                      SelectedButtonBG;                                          // 0x04E0(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass LockerVerticalItemEntry_WidgetBP.LockerVerticalItemEntry_WidgetBP_C");
		return ptr;
	}
