...
{
public:
	unsigned char                                      UnknownData_ZJVY[0x58];                                    // 0x0028(0x0058) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_OCQ9[0x17];                                    // 0x0099(0x0017) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NJMY[0x2];                                     // 0x00C2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_THEN[0x3];                                     // 0x00C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KFC3[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BI0A[0x2C];                                    // 0x00F4(0x002C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1WJ0[0x8];                                     // 0x0130(0x0008) MISSED OFFSET (PADDING)
...
// 0x0160 (FullSize[0x0820] - InheritedSize[0x06C0])
...
public:
	...
	unsigned char                                      UnknownData_U16F[0x3];                                     // 0x06C0(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_XWQ0[0x3];                                     // 0x06C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JCZ1[0x4];                                     // 0x06DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XT5Y[0x138];                                   // 0x06E8(0x0138) MISSED OFFSET (PADDING)
...
// 0x00E4 (FullSize[0x0260] - InheritedSize[0x017C])
...
public:
	...
	TEnumAsByte<MediaAssets_EMediaTextureOutputFormat> OutputFormat;                                              // 0x018F(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TEnumAsByte<MediaAssets_EMediaTextureOrientation>  CurrentOrientation;                                        // 0x0194(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, TextExportTransient, HasGetValueTypeHash, NativeAccessSpecifierPublic, CPF_SkipSerialization)
	unsigned char                                      UnknownData_OKZB[0x3];                                     // 0x0195(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NTI7[0xC0];                                    // 0x01A0(0x00C0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FUX9[0x3];                                     // 0x0089(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
