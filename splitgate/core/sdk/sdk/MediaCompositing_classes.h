...
public:
	...
	unsigned char                                      UnknownData_4OV8[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7TVP[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_L1S3[0x3];                                     // 0x00F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PXB2[0x7];                                     // 0x0109(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_0RRX[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
