...
{
public:
	unsigned char                                      UnknownData_UMGA[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JTNO[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_LDFV[0x28];                                    // 0x0068(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NNRT[0x3];                                     // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HMUO[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6EPE[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HFYE[0x20];                                    // 0x00A0(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6AR3[0x10];                                    // 0x0058(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IMB8[0x70];                                    // 0x0068(0x0070) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XYDH[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XEQT[0xE];                                     // 0x00DA(0x000E) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4CT4[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OK03[0x6];                                     // 0x00EA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HDMR[0x110];                                   // 0x0110(0x0110) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_VXE5[0xB];                                     // 0x0221(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QGYJ[0x4];                                     // 0x023C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_GU6J[0x78];                                    // 0x0060(0x0078) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_J4YE[0x2];                                     // 0x00DA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_E1LT[0x3];                                     // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J2JR[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (PADDING)
