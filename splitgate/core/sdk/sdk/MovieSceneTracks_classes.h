...
public:
	...
	{
		static auto ptr = UObject::FindClass("Class MovieSceneTracks.MovieSceneCameraShakeEvaluator");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_2B1R[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_TWMF[0x8];                                     // 0x0110(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N535[0x2];                                     // 0x012E(0x0002) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_M7B6[0x2];                                     // 0x01B2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BS9O[0x3];                                     // 0x01B5(0x0003) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_P89Z[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_WKF1[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0IR0[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMovieSceneTransformMask                    TransformMask;                                             // 0x00F0(0x0004) (NoDestructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_UWK5[0x4];                                     // 0x00F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EKDH[0x7];                                     // 0x0739(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JIJM[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SK9L[0x4];                                     // 0x0104(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HY0Q[0x5];                                     // 0x02FB(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_IL3A[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_S6SX[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZV13[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	class UEnum*                                       Enum;                                                      // 0x00A8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	unsigned char                                      UnknownData_P3WM[0x7];                                     // 0x0121(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PEEY[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_S9SM[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KCKF[0x3];                                     // 0x00F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L209[0x4];                                     // 0x011C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VTFO[0xF];                                     // 0x0151(0x000F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_W476[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_YTGB[0x68];                                    // 0x0050(0x0068) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_UNRT[0x3];                                     // 0x0115(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1MO8[0x4];                                     // 0x0124(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_72OU[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_6B39[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_H10A[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UMovieSceneSection*>                  CameraShakeSections;                                       // 0x0080(0x0010) (ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
{
public:
	struct FString                                     ShotDisplayName;                                           // 0x0168(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FText                                       DisplayName;                                               // 0x0178(0x0018) (Deprecated, NativeAccessSpecifierPrivate)
...
{
public:
	unsigned char                                      UnknownData_1DL8[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	bool                                               bIsSlateColor;                                             // 0x00A8(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_GA5Q[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_S2TN[0x180];                                   // 0x0040(0x0180) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4PR4[0x1E0];                                   // 0x0040(0x01E0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9DUL[0x180];                                   // 0x0040(0x0180) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_R7WW[0x18];                                    // 0x0040(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BTRV[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_G012[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_EYHZ[0x50];                                    // 0x0040(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_09R8[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L2BW[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NNVD[0x3];                                     // 0x0085(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_ZU73[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_TYI4[0x7];                                     // 0x0199(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_71HQ[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AKLR[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class MovieSceneTracks.MovieSceneIntegerPropertySystem");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_YKD2[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_A7MN[0x1A8];                                   // 0x0040(0x01A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FV8N[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QTZD[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_QYBW[0x168];                                   // 0x0040(0x0168) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EC62[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_BHNS[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JM40[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_J641[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_YIPF[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UMovieSceneSection*>                  Sections;                                                  // 0x0080(0x0010) (ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
{
public:
	unsigned char                                      UnknownData_D94F[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_A5EG[0x28];                                    // 0x0060(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LTTT[0x28];                                    // 0x0060(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FI8N[0x28];                                    // 0x0060(0x0028) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class MovieSceneTracks.MovieScenePiecewiseEnumBlenderSystem");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_JJRC[0xC0];                                    // 0x0060(0x00C0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LR9F[0x48];                                    // 0x0060(0x0048) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class MovieSceneTracks.MovieScenePiecewiseIntegerBlenderSystem");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_83QB[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O49X[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2OH7[0x250];                                   // 0x0040(0x0250) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_IMXY[0x3];                                     // 0x01DD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LEVY[0x3];                                     // 0x0201(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V27K[0x47];                                    // 0x0229(0x0047) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FY0D[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GBNY[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BB22[0x7];                                     // 0x00C9(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_05NN[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CRRU[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5A9B[0x38];                                    // 0x0040(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class MovieSceneTracks.MovieSceneVectorPropertySystem");
		return ptr;
	}
...
// 0x0290 (FullSize[0x0378] - InheritedSize[0x00E8])
class UMovieSceneVectorSection : public UMovieSceneSection
{
public:
	unsigned char                                      UnknownData_IY1B[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMovieSceneFloatChannel                     Curves[0x4];                                               // 0x00F0(0x0280) (NativeAccessSpecifierPrivate)
	int                                                ChannelsUsed;                                              // 0x0370(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_EZEH[0x4];                                     // 0x0374(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	int                                                NumChannelsUsed;                                           // 0x00A8(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_P4HL[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3GZ1[0x50];                                    // 0x0040(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IQYI[0x38];                                    // 0x0040(0x0038) MISSED OFFSET (PADDING)
