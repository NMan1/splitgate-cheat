...
enum class MovieScene_EMovieSceneServerClientMask : uint8_t
{
...
struct FMovieSceneEasingSettings
{
	...
	unsigned char                                      UnknownData_V1HG[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5XT0[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_ARPB[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FMovieSceneTrackEvalOptions
{
	...
	unsigned char                                      UnknownData_D6KM[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneTrackEvaluationFieldEntry
{
	...
	unsigned char                                      UnknownData_18F8[0x1];                                     // 0x001D(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneSequenceReplProperties
{
	...
	unsigned char                                      UnknownData_V17B[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneRootEvaluationTemplateInstance
{
	...
	unsigned char                                      UnknownData_6DTR[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6N8X[0x70];                                    // 0x0020(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FMovieSceneSequenceID, class UObject*> DirectorInstances;                                         // 0x0090(0x0050) (NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_FSUI[0x8];                                     // 0x00E0(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneSequencePlaybackSettings
{
	...
	unsigned char                                      UnknownData_61JP[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AASY[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneSectionParameters
{
	...
	unsigned char                                      UnknownData_I8QY[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneMarkedFrame
{
	...
	unsigned char                                      UnknownData_MP9S[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneObjectBindingID
{
	...
	int                                                SequenceID;                                                // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int                                                ResolveParentIndex;                                        // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
struct FMovieSceneSpawnable
{
	...
	unsigned char                                      UnknownData_0SIH[0x1];                                     // 0x0043(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TW8W[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DDLZ[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TJ9Y[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneBindingOverrideData
{
	...
	unsigned char                                      UnknownData_T7Z5[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_I052[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneBoolChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_DYMA[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<bool>                                       Values;                                                    // 0x0020(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_83N9[0x60];                                    // 0x0030(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_X579[0x88];                                    // 0x0000(0x0088) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TR65[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9AAP[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_F9UZ[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7PNR[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3OWE[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0JAW[0x80];                                    // 0x0000(0x0080) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMovieSceneEntitySystemGraphNodes           Nodes;                                                     // 0x0080(0x0038) (NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_N61R[0x80];                                    // 0x00B8(0x0080) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LXPL[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
{
	TScriptInterface<class UMovieSceneEvaluationHook>  Interface;                                                 // 0x0000(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_X7CS[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FMovieSceneEvaluationHookEvent
{
	...
	unsigned char                                      UnknownData_W10H[0x18];                                    // 0x0020(0x0018) MISSED OFFSET (PADDING)
...
{
	class UMovieSceneSection*                          Section;                                                   // 0x0000(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_S5DN[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KGDJ[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FMovieSceneEvalTemplate : public FMovieSceneEvalTemplateBase
{
	...
	unsigned char                                      UnknownData_D3JI[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2D41[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FTrackInstanceInputComponent
{
	...
	unsigned char                                      UnknownData_H080[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneByteChannel : public FMovieSceneChannel
{
	...
	bool                                               bHasDefaultValue;                                          // 0x0019(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_HM47[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L33W[0x60];                                    // 0x0038(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4H0V[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_7OH2[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FMovieSceneSubSectionData
{
	...
	unsigned char                                      UnknownData_QWUO[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneTangentData
{
	...
	unsigned char                                      UnknownData_MI89[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneFloatValue
{
	...
	unsigned char                                      UnknownData_JRB8[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (PADDING)
...
struct FMovieSceneFloatChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_Z18Q[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TXHG[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneIntegerChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_8N27[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<int>                                        Values;                                                    // 0x0020(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_E2WH[0x60];                                    // 0x0030(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2H55[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneKeyTimeStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_688U[0x1C];                                    // 0x000C(0x001C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BO9U[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FMovieSceneObjectPathChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_94XS[0x60];                                    // 0x0060(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieScenePropertyBinding
{
	...
	unsigned char                                      UnknownData_6XXL[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G12S[0x58];                                    // 0x0000(0x0058) MISSED OFFSET (PADDING)
...
struct FSectionEvaluationData
{
	...
	unsigned char                                      UnknownData_S1IK[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FUIG[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Y4OM[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneSequencePlaybackParams
{
	...
	unsigned char                                      UnknownData_3BKI[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1967[0x6];                                     // 0x0022(0x0006) MISSED OFFSET (PADDING)
...
struct FMovieSceneTrackDisplayOptions
{
	...
	unsigned char                                      UnknownData_6ZMG[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneSequenceHierarchyNode
{
	...
	unsigned char                                      UnknownData_QKLI[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneEvaluationTrack
{
	...
	unsigned char                                      UnknownData_XOMB[0x1];                                     // 0x0013(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2R6O[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7U1W[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneTemplateGenerationLedger
{
	...
	unsigned char                                      UnknownData_IDM7[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneEvaluationTemplate
{
	...
	unsigned char                                      UnknownData_K19Z[0x50];                                    // 0x0050(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MXYQ[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FMovieSceneTimeTransform                    LinearTransform;                                           // 0x0000(0x000C) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_HCFY[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneSubSequenceData
{
	...
	unsigned char                                      UnknownData_8MFZ[0x1];                                     // 0x0097(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMovieSceneSequenceInstanceDataPtr          InstanceData;                                              // 0x0098(0x0018) (NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_TLPK[0x8];                                     // 0x00B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneFieldEntry_EvaluationTrack
{
	...
	unsigned char                                      UnknownData_22JP[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FMovieSceneFieldEntry_ChildTemplate
{
	...
	unsigned char                                      UnknownData_U37K[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FFrameNumber                                ForcedTime;                                                // 0x0004(0x0004) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
	struct FString                                     OverrideBoundPropertyPath;                                 // 0x0000(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameNumber                                ForcedTime;                                                // 0x0010(0x0004) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_QXQZ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	MovieScene_ESectionEvaluationFlags                 Flags;                                                     // 0x0018(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_N4NA[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (PADDING)
