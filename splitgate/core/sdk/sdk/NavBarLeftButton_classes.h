...
class UNavBarLeftButton_C : public UPortalWarsButtonWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass NavBarLeftButton.NavBarLeftButton_C");
		return ptr;
	}
