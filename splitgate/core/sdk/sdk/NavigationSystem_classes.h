...
public:
	...
	unsigned char                                      UnknownData_P6Q0[0x6];                                     // 0x0042(0x0006) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RUL0 : 1;                                      // 0x0068(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_1K3C[0x2];                                     // 0x006A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AV8W[0x3];                                     // 0x0071(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_20R6[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2I36[0x10];                                    // 0x00B0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UOV2[0xDC];                                    // 0x00E0(0x00DC) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KSTG[0x13FF];                                  // 0x01BD(0x13FF) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KCYL[0x20];                                    // 0x15C0(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Z9GZ[0x8];                                     // 0x0220(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FCOW[0x3];                                     // 0x02A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7G9S[0x3];                                     // 0x02AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RGIB[0x108];                                   // 0x02B8(0x0108) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FSupportedAreaData>                  SupportedAreas;                                            // 0x03C0(0x0010) (ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_GD86[0x58];                                    // 0x03D0(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RT8R[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HXDI[0x2F];                                    // 0x00A9(0x002F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_73NV[0x3F];                                    // 0x0049(0x003F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XXQ2[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RYW6[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KKFA[0x10];                                    // 0x0220(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PMFF[0x7];                                     // 0x0241(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BLVW[0x4];                                     // 0x0284(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YNU4[0x3];                                     // 0x029D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3Z1Q[0x3];                                     // 0x02A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SV95[0x3];                                     // 0x02AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CK9Z[0x3];                                     // 0x02B9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_009H[0x30];                                    // 0x02E0(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZPCL[0x8];                                     // 0x0450(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8LUD[0x8];                                     // 0x0468(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NYAR[0x24];                                    // 0x00B0(0x0024) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HT5S[0x3];                                     // 0x00D5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_1KG4[0x8];                                     // 0x00E0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DM6W[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YM4L[0x3];                                     // 0x011D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EN62[0x3];                                     // 0x0121(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7UFD[0x4];                                     // 0x013C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BZFQ[0x3F];                                    // 0x0151(0x003F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_T2QT[0x4];                                     // 0x025C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GTX5[0x10];                                    // 0x0450(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_6U2D[0x4B];                                    // 0x00F5(0x004B) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QTUD[0x8];                                     // 0x0258(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8PZM[0x7];                                     // 0x0269(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RYZJ[0x6];                                     // 0x022A(0x0006) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      bDrawPolygonFlags : 1;                                     // 0x0429(0x0001) BIT_FIELD (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      bDrawMarkedForbiddenPolys : 1;                             // 0x042A(0x0001) BIT_FIELD (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_4HKM[0x1];                                     // 0x042B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QGE8[0x3];                                     // 0x0431(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KB1E[0x2];                                     // 0x048E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QT9A[0x2];                                     // 0x049A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O7SO[0x30];                                    // 0x04A8(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8ZIB[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)
