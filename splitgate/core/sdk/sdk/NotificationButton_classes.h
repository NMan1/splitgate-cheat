...
// WidgetBlueprintGeneratedClass NotificationButton.NotificationButton_C
// 0x0018 (FullSize[0x03D8] - InheritedSize[0x03C0])
class UNotificationButton_C : public UPortalWarsButtonWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass NotificationButton.NotificationButton_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_NotificationButton(int EntryPoint);
};
