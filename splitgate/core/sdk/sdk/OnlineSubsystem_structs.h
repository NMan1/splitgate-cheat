...
struct FInAppPurchaseProductInfo
{
	...
	unsigned char                                      UnknownData_ZBPE[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInAppPurchaseProductRequest
{
	...
	unsigned char                                      UnknownData_VC3G[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
