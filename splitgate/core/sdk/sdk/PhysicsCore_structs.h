...
{
	unsigned char                                      UnknownData_2QJ6[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NJ3U[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
