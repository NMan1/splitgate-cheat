...
struct FPropertyAccessSegment
{
	...
	unsigned char                                      UnknownData_9T7J[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
...
struct FPropertyAccessPath
{
	...
	unsigned char                                      UnknownData_WMQU[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FPropertyAccessCopy
{
	...
	unsigned char                                      UnknownData_HCR8[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FPropertyAccessIndirectionChain
{
	...
	unsigned char                                      UnknownData_PIE4[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FPropertyAccessIndirection
{
	...
	unsigned char                                      UnknownData_ZKNV[0x6];                                     // 0x003A(0x0006) MISSED OFFSET (PADDING)
...
struct FPropertyAccessLibrary
{
	...
	unsigned char                                      UnknownData_BUGH[0x18];                                    // 0x00B0(0x0018) MISSED OFFSET (PADDING)
