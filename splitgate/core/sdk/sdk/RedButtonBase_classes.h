...
// WidgetBlueprintGeneratedClass RedButtonBase.RedButtonBase_C
// 0x0030 (FullSize[0x03F0] - InheritedSize[0x03C0])
class URedButtonBase_C : public UPortalWarsButtonWidget
{
public:
	...
	unsigned char                                      UnknownData_YIUB[0x7];                                     // 0x03E1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass RedButtonBase.RedButtonBase_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_RedButtonBase(int EntryPoint);
};
