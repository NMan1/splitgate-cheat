...
struct FStructSerializerNumericTestStruct
{
	...
	unsigned char                                      UnknownData_BB3H[0x1];                                     // 0x0001(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RS12[0x1];                                     // 0x0011(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D15Z[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStructSerializerBuiltinTestStruct
{
	...
	unsigned char                                      UnknownData_22Y6[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_11DH[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_055B[0xC];                                     // 0x0084(0x000C) MISSED OFFSET (PADDING)
...
struct FStructSerializerArrayTestStruct
{
	...
	unsigned char                                      UnknownData_4GLP[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStructSerializerTestStruct
{
	...
	unsigned char                                      UnknownData_A06Y[0x5];                                     // 0x0033(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FStructSerializerObjectTestStruct           Objects;                                                   // 0x0038(0x00A0) (NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_N7AC[0x8];                                     // 0x00D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStructSerializerByteArray
{
	...
	unsigned char                                      UnknownData_B9J7[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E95B[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4P33[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
