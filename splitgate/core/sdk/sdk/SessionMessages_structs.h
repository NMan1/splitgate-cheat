...
{
	unsigned char                                      UnknownData_WGYA[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7XC3[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FSessionServiceLog
{
	...
	unsigned char                                      UnknownData_UAI2[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FSessionServicePong
{
	...
	unsigned char                                      UnknownData_UFNF[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WVTS[0x7];                                     // 0x0089(0x0007) MISSED OFFSET (PADDING)
