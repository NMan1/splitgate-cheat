...
// WidgetBlueprintGeneratedClass SettingsButton.SettingsButton_C
// 0x0018 (FullSize[0x03D8] - InheritedSize[0x03C0])
class USettingsButton_C : public UPortalWarsButtonWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass SettingsButton.SettingsButton_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_SettingsButton(int EntryPoint);
};
