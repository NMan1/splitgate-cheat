...
struct FGeometry
{
	unsigned char                                      UnknownData_V63H[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FSlateColor
{
	...
	unsigned char                                      UnknownData_XCY7[0x17];                                    // 0x0011(0x0017) MISSED OFFSET (PADDING)
...
struct FSlateBrush
{
	unsigned char                                      UnknownData_ADZJ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CZN4[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R10C[0x7];                                     // 0x0081(0x0007) MISSED OFFSET (PADDING)
...
struct FInputEvent
{
	unsigned char                                      UnknownData_7U1V[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_L4OM[0x58];                                    // 0x0018(0x0058) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_F030[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BAST[0x20];                                    // 0x0018(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UURI[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9DWI[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
struct FFontOutlineSettings
{
	...
	unsigned char                                      UnknownData_GWIN[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSlateFontInfo
{
	...
	unsigned char                                      UnknownData_ETNZ[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FIWN[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_790V[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FSlateSound
{
	...
	unsigned char                                      UnknownData_FA8Y[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FFontData
{
	...
	unsigned char                                      UnknownData_99UJ[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCompositeFallbackFont
{
	...
	unsigned char                                      UnknownData_HJ5E[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_96Q5[0x30];                                    // 0x0018(0x0030) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3M30[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FFocusEvent
{
	unsigned char                                      UnknownData_HUL0[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FDockTabStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_8UV5[0x4];                                     // 0x06D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInlineTextImageStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_OYL6[0x6];                                     // 0x0092(0x0006) MISSED OFFSET (PADDING)
...
struct FSliderStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_R98U[0x4];                                     // 0x033C(0x0004) MISSED OFFSET (PADDING)
...
struct FSearchBoxStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_RECG[0x7];                                     // 0x0A89(0x0007) MISSED OFFSET (PADDING)
...
struct FExpandableAreaStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_WIOU[0x4];                                     // 0x011C(0x0004) MISSED OFFSET (PADDING)
...
struct FCheckBoxStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_KS6T[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
