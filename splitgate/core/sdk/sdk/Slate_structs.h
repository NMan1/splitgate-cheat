...
struct FInputChord
{
	...
	unsigned char                                      UnknownData_FZA7[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FCustomizedToolMenuEntry
{
	...
	unsigned char                                      UnknownData_L5LI[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	Slate_ECustomizedToolMenuVisibility                Visibility;                                                // 0x0000(0x0001) ELEMENT_SIZE_MISMATCH (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_RTLO[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FCustomizedToolMenu
{
	...
	unsigned char                                      UnknownData_MU9L[0xE0];                                    // 0x0108(0x00E0) MISSED OFFSET (PADDING)
