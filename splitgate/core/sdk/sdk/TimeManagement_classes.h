...
public:
	...
	unsigned char                                      UnknownData_FAPB[0x18];                                    // 0x0030(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class TimeManagement.GenlockedFixedRateCustomTimeStep");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_I1XO[0x27];                                    // 0x0031(0x0027) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_67QC[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
